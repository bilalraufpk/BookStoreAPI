USE [master]
GO
/****** Object:  Database [BookStore]    Script Date: 8/19/2020 1:17:34 PM ******/
...
USE [BookStore]
GO
/****** Object:  Table [dbo].[BookCategories]    Script Date: 8/19/2020 1:17:34 PM ******/
SET ANSI_NULLS ON
GO
...
(
 ...
 CONSTRAINT [UC_BookCategories] UNIQUE NONCLUSTERED 
(
	[Name] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Books]    Script Date: 8/19/2020 1:17:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [UC_Books_ISBN] UNIQUE NONCLUSTERED 
(
	[ISBN] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  View [dbo].[View_Books]    Script Date: 8/19/2020 1:17:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT        dbo.Books.Id, dbo.Books.ISBN, dbo.Books.Title, dbo.Books.Year, dbo.Books.Price, dbo.Books.CategoryId, dbo.Books.DateTime, dbo.BookCategories.Name AS CategoryName
FROM            dbo.Books INNER JOIN
                         dbo.BookCategories ON dbo.Books.CategoryId = dbo.BookCategories.Id
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_Books'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_Books'
GO
USE [master]
GO
